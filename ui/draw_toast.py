...
from ui.theme import SCREEN_W, SCREEN_H, COL_TOAST_BG, COL_TOAST_EDGE, COL_CARD_BORDER, COL_TEXT_LIGHT, TOAST_MS, ease_out
...
def draw_toast(gm, now):
    ...
    surf = gm.f_small.render(gm.toast, True, COL_TEXT_LIGHT)
    ...
    pygame.draw.rect(scr, COL_CARD_BORDER, tr, 1, border_radius=6)
